    ...
    <View style={{ minHeight: 400 }}>
      ...
      <View>
        {notes?.length == null ? (
          ...
          >
            Note note availble for this project
          </Text>
        ) : (
          <>
            {notes?.map((item) => (
              <View key={item.id} style={styles.notebox}>
                ...
                <View style={styles.sec1}>
                  ...
                  <Text style={styles.txtb}>
                    {' '}
                    {moment(item?.created_at).format('MM-DD-YY, h:mm:ss a')}
                  </Text>
                  {notes.myaccountinfo?.id == item?.user_id && (
                    <TouchableOpacity
                      onPress={() => handleDeletedNote(item)}
                      style={styles.downloadbox2}
                    >
                      <Feather name='trash' color='red' size={12} />
                ...
                <View style={styles.sec2}>
                  ...
                  >
                    <Feather name='download' color='#66C825' size={12} />
